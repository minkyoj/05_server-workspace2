...
public class JqAjaxController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		=> sucess:function의 매개변수에 연이어서 하나의 문자열로 담겨있음
		*/
		...
		/*
		JSONArray jArr = new JSONArray(); // [] 빈 배열이 만들어졌다고 생각하면 됨
		jArr.add(name); // ["차은우"]
		jArr.add(age); // ["차은우",20]
		
		response.setContentType("application/json; charset=utf-8"); // json데이터 응답시에
